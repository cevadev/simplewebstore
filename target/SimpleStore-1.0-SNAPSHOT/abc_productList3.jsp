<!-- Formulario que maneja la lista de producto -->
...
<div align="center"><h3>Cat&aacute;logo de productos versi&oacute;n 3</h3></div>
...
<tr>
    ...
    <td><a href="abc_product3.jsp?action=edit&id_product=<%=id_product%>">[Ed]</a>
        <a href="abc_product3.jsp?action=del&id_product=<%=id_product%>">[X]</a></td>
</tr>
<% } %>
</table>
...
<div align="center">
<p>
<a href="abc_product3.jsp?action=edit">Nuevo</a><p>
