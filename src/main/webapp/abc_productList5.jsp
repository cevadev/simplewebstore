...
<!-- el atributo cat contiene la instancia del objeto CatProduct5 -->
<% CatProduct5 cat = (CatProduct5) request.getAttribute("cat"); %>
<!DOCTYPE html>
<html>
    <head>
...
<div align="center"><h3>Cat&aacute;logo de productos versi&oacute;n 5</h3></div>
...
<tr>
    ...
    <td><a href="abc_product5.jsp?action=edit&id_product=<%=id_product%>">[Ed]</a>
        <a href="abc_product5.jsp?action=del&id_product=<%=id_product%>">[X]</a></td>
</tr>
<% } %>
</table>
...
<div align="center">
<p>
<a href="abc_product5.jsp?action=edit">Nuevo</a><p>
